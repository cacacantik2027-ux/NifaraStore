...
- Gambar QRIS + catatan pembayaran
- Info transfer bank
...
statis toko, bot otomatis kirim gambar itu + instruksi setiap ada order,
lalu customer kirim bukti transfer manual ke chat untuk diverifikasi admin.

...
// Jalankan bot
if (BOT_MODE === "webhook") {
  console.log("[bot] Mode webhook belum dikonfigurasi otomatis di starter ini — gunakan bot.start() (polling) dulu, atau tambahkan express webhook handler grammY sesuai kebutuhan hosting kamu.");
  bot.start();
} else {
  bot.start();

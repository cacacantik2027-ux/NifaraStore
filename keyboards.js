...
// Halaman "Katalog & Pricelist": cukup tampilkan pricelist lengkap (semua
// kategori & produk beserta harga), TANPA tombol per-produk. Customer
// memilih produk yang mau dibeli lewat live chat langsung dengan admin
// setelah melihat pricelist ini.
function catalogListKeyboard() {
  return {
    inline_keyboard: [
      [btn("🛒 Order Sekarang", { callback_data: "menu:catalogorder" }, "success")],
      backButton(),
    ],
  };
}
